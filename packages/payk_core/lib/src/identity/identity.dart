...
class Identity {
  ...
  static const String _ed25519Info = 'payk/identity/ed25519/v1';
  static const String _x25519Info = 'payk/identity/x25519/v1';
  ...
  static final List<int> _hkdfSalt = utf8.encode('payk/identity/hkdf-salt/v1');
